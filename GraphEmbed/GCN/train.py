...
if FILTER == 'localpool':
    ...
    # print("graph.shape ",  graph[1].shape)
    # print(X)
    # print(A_)
    # print(graph)
    G = [Input(shape=(None, None), batch_shape=(None, None), sparse=True)]  #数组，包含Input一个元素
...
X_in = Input(shape=(X.shape[1],))  #一个节点有1433 features.，所以输入形状就是X.shape[1]， 样本点个数不定，可能是batch个
