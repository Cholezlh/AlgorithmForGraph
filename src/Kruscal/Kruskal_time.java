...
public class Kruskal_time {
	 ...
	 * @throws IOException 
     */  
	public static void KRUSKAL(HashSet<Long> v, ArrayList<Edge_Time> E, BufferedWriter bw) throws IOException{
        ...
        for(int n=0;n<E.size();n++){  
            ...
            if(counti!=countj){   //不含圈
                ...
                bw.write(src + "\t" + dst + "\t" + E.get(n).money + "\t" + E.get(n).time + "\n"); 
...
//                System.out.println("setj " +  setj); 
    ...
    public static void main(String [] args) throws IOException, NoSuchAlgorithmException{  
    	...
    	ArrayList<Edge_Time> E= new ArrayList<Edge_Time>();
        
    	File file = new File("test1_interest_e.txt");
        ...
        try {
            ...
            while ((tempString = reader.readLine()) != null) {
                ...
                Long srcId = HashMD5.getMD5(tempString.split("\\t")[0]);
                Long dstId = HashMD5.getMD5(tempString.split("\\t")[1]);
                Double money = Double.parseDouble(tempString.split("\\t")[2]);
                Long time = Long.parseLong(tempString.split("\\t")[3]);
                Double w = 1/money;
                //System.out.println(weight);
                E.add(new Edge_Time(srcId,dstId,w,money,time));
                V.add(srcId);
                V.add(dstId);
            }
        ...
        FileOutputStream fos=new FileOutputStream(new File("testout_time.csv"));
    	OutputStreamWriter osw=new OutputStreamWriter(fos, "UTF-8");
    	BufferedWriter bw=new BufferedWriter(osw);
       
    	bw.write("source\ttarget\tmoney\ttime\n");
        KRUSKAL(V, E, bw);  
